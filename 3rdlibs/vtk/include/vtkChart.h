...
public:
   ...
   */
  enum {
    FILL_CIM,  // Attempt to fill the entire CIM.
   ...
   * valid enums are FILL_CIM, FILL_RECT and AXES_TO_RECT.
   */
  ...
  {
    this->LayoutStrategy = isAutoSized ? vtkChart::FILL_CIM :
                                         vtkChart::FILL_RECT;
  }
  virtual bool GetAutoSize()
  {
    return this->LayoutStrategy == vtkChart::FILL_CIM ? true : false;
  }
  //@}
   ...
   * selection. The only valid enums are vtkContextCIM::SELECTION_NONE,
