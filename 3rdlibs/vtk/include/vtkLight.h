 ...
 * CIMLight is part of the CIM itself and does not move with the camera.
...
#define VTK_LIGHT_TYPE_CIM_LIGHT  3
...
public:
   ...
   * set to (0,0,1). The light is a CIMLight, its color is white
   ...
   * A CIMLight is a light located in the world coordinate space.  A light
   * is initially created as a CIM light.
  ...
  void SetLightTypeToCIMLight()
    { this->SetLightType(VTK_LIGHT_TYPE_CIM_LIGHT); }
