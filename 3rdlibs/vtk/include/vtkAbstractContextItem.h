 ...
 *
 *
 * This class is the common base for all context CIM items. You should
...
public:
   ...
   * The CIM should take care of calling this on all items before their
  ...
  /**
   * Set the vtkContextCIM for the item, always set for an item in a CIM.
   */
  virtual void SetCIM(vtkContextCIM *CIM);

  /**
   * Get the vtkContextCIM for the item, always set for an item in a CIM.
   */
  ...
  /**
   * Maps the point to the CIM coordinate system.
   */
  virtual vtkVector2f MapToCIM(const vtkVector2f& point);

  /**
   * Maps the point from the CIM coordinate system.
   */
  virtual vtkVector2f MapFromCIM(const vtkVector2f& point);
...
protected:
  ...
  /**
   * Point to the CIM the item is on - can be null.
   */
  vtkContextCIM* CIM;
