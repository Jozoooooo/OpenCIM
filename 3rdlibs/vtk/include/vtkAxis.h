...
public:
   ...
   * locations etc. Should be called by the CIM before rendering.
   */
  ...
  /**
   * An array with the positions of the tick marks along the axis line.
   * The positions are specified in CIM coordinates.
   */
  virtual vtkFloatArray* GetTickCIMPositions();
...
protected:
   ...
   * Position of tick marks in screen coordinates
   */
  vtkSmartPointer<vtkFloatArray> TickCIMPositions;
