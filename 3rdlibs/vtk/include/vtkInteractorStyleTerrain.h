 ...
 * @brief   manipulate camera in CIM with natural view up (e.g., terrain)
 *
 * vtkInteractorStyleTerrain is used to manipulate a camera which is viewing
 * a CIM with a natural view up, e.g., terrain. The camera in such a
 * CIM is manipulated by specifying azimuth (angle around the view
 ...
 * mouse button pans the camera across the CIM (again the shift key has a
