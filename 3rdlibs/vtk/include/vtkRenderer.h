...
public:
  ...
  /**
   * Ask the lights in the CIM that are not in world space
   ...
   * rendering its CIM. This is used by vtkLODActor's.
   */
...
protected:
  ...
  /**
   * Update the geometry of the lights in the CIM that are not in world
   ...
   * to antialias the CIM. Default is off.
   */
  bool UseFXAA;
