 ...
 * vtkContextCIM. Passed to vtkAbstractContextItem objects.
*/
...
public:
  ...
  /**
   * Set/get the position of the mouse in CIM coordinates.
   */
  void SetCIMPos(const vtkVector2f &pos) { this->CIMPos = pos; }
  vtkVector2f GetCIMPos() const { return this->CIMPos; }
   ...
   * Set/get the position of the mouse in CIM coordinates.
   */
  void SetLastCIMPos(const vtkVector2f &pos) { this->LastCIMPos = pos; }
  vtkVector2f GetLastCIMPos() const { return this->LastCIMPos; }
...
protected:
  ...
  /**
   * Position of the mouse the CIM coordinate system.
   */
  vtkVector2f CIMPos;
  ...
  /**
   * `CIMPos'at the previous mouse event.
   */
  vtkVector2f LastCIMPos;
