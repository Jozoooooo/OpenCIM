 ...
 *
 * vtkCellPicker will shoot a ray into a 3D CIM and return information
...
public:
   ...
   * CIM.  You must set up the locator with exactly the same data set
   * that was input to the mapper of one or more of the actors in the
   * CIM.  As well, you must either build the locator before doing the
