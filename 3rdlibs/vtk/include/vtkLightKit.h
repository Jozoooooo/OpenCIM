 ...
 * CIMs simple, flexible, and attractive (or at least not horribly
 ...
 * CIM from about a 45 degree angle vertically and at least a little
 * offset side to side.  The key light usually at least about twice as
 * bright as the total of all other lights in the CIM to provide good
 ...
 * in the CIM.  The headlight, always located at the position of the
 ...
 * brightness of all the lights in the CIM can be changed by
...
public:
   ...
   * brightest light in the CIM.  The intensities of the other two
   ...
   * As such, a headlight tends to reduce the contrast of a CIM.  It
