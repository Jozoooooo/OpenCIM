 ...
 *
 *
 * This item draws a heatmap as a part of a vtkContextCIM.
 *
 * .SEE ALSO
 * vtkTable
*/
...
protected:
  ...
  /**
   * Get the value for the cell of the heatmap located at CIM position (x, y)
...
private:
  ...
  std::vector< vtkIdType > CIMRowToTableRowMap;
  std::vector< vtkIdType > CIMColumnToTableColumnMap;
  ...
  double MaxX;
  double MaxY;
  double CIMBottomLeft[3];
  double CIMTopRight[3];
  float RowLabelWidth;
