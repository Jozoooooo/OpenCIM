 ...
 * CIM. The line has two handles (at its endpoints), plus the line can be
 * picked to translate it in the CIM.  A nice feature of the object is that
 * the vtkLineWidget, like any 3D widget, will work with the current
 * interactor style and any other widgets present in the CIM. That is, if
