...
public:
  ...
  //@{
  /**
   * Set the resting distance of each link in CIM units, which is equal to
   * pixels when there is no CIM scaling. Default is 20.
   */
   ...
   * should be set to the location in the center of the CIM.
