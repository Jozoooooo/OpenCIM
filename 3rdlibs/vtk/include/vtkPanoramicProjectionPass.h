 ...
 * @brief   Render pass that render the CIM in a cubemap and project
...
public:
   ...
   * Azimuthal equidistant projection maps all points of the CIM based on their distance to the
