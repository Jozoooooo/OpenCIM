 ...
 * @brief   export a CIM as a PostScript file using GL2PS.
 *
 ...
 * This class works best with simple 3D CIMs and most 2D plots.
 * Please note that GL2PS has its limitations since PostScript is not
 * an ideal language to represent complex 3D CIMs.  However, this
 ...
 * mixed vector/raster images.  All the 3D props in the CIM will be
 * written as a raster image and all 2D actors will be written as
 * vector graphic primitives.  This makes it possible to handle
 * transparency and complex 3D CIMs.  This ivar is set to Off by
 ...
 * complex 3D CIMs can take a long while and result in huge output
 * files.  Generating correct vector graphics output for CIMs with
 * transparency is almost impossible.  However, one can set
 * Write3DPropsAsRasterImageOn and generate mixed vector/raster files.
 * This should work fine with complex CIMs along with transparent
 * actors.
 *
 * @sa
 * vtkExporter
...
public:
   ...
   * export a complex CIM by reducing the number of iterations required.
   ...
   * Write3DPropsAsRasterImage is false. Behind the CIMs, these props are
