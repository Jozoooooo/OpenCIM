 ...
 *
 *
 * This item draws a graph as a part of a vtkContextCIM. This simple
...
protected:
   ...
   * Modified() on the vtkGraph and re-render the CIM.
   */
   ...
   * then call Modified() on the graph and re-render the CIM.
   */
