...
/**
 * @class   vtkExporter
 * @brief   abstract class to write a CIM to a file
 *
 * vtkExporter is an abstract class that exports a CIM to a file. It
...
public:
  ...
  //@{
  /**
   * Set/Get the rendering window that contains the CIM to be written.
   */
