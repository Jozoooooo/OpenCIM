...
-------------------------------------------------------------------------*/
// .NAME QVTKGraphicsItem - provides a way to view a VTK CIM as an item in QGraphicsView
//
// .SECTION Description
//
...
class VTKGUISUPPORTQTOPENGL_EXPORT QVTKGraphicsItem : public QGraphicsWidget
{
  ...
  public Q_SLOTS:
    ...
    // it just causes the current contents in the window to draw to the QGraphicsCIM
    virtual void Update();
  ...
  protected:
    ...
    void mousePressEvent(QGraphicsCIMMouseEvent* e);
    void mouseReleaseEvent(QGraphicsCIMMouseEvent* e);
    void mouseMoveEvent(QGraphicsCIMMouseEvent* e);
    void resizeEvent(QGraphicsCIMResizeEvent* e);
    void moveEvent(QGraphicsCIMMoveEvent* e);
    void wheelEvent(QGraphicsCIMWheelEvent* e);
    void hoverEnterEvent(QGraphicsCIMHoverEvent* e);
    void hoverLeaveEvent(QGraphicsCIMHoverEvent* e);
    void hoverMoveEvent(QGraphicsCIMHoverEvent* e);
